...
public class MoveRigidBody3DOnKey : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        if (Input.GetButton(Button.KeyName))
        {
            ...
            position.Set(
                rb3d.position.x + Direction.x * Force * Time.deltaTime * horizontal,
                rb3d.position.y + Direction.y * Force * Time.deltaTime * horizontal,
                rb3d.position.z + Direction.z * Force * Time.deltaTime * horizontal);
